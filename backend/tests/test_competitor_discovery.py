...
def test_build_messages_includes_target_and_exclusions():
    ...
    assert "Exactly 3 competitors from the SAME company tier" in user
    assert "Exactly 3 same_level_competitors" in user
    assert "Exactly 3 one_level_above_competitors" in user
    ...
    same = [
        {
            ...
            "intersections": None,
            "reasoning": "match",
            "citations": [{"type": "homepage", "url": f"https://c{i}.com.au", "evidence": "e"}],
        }
    ...
    above = [
        {
            ...
            "reasoning": "above",
            "citations": [{"type": "homepage", "url": f"https://u{i}.com.au", "evidence": "e"}],
        }
